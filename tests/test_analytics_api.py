...
async def test_stats_summary_with_events(superuser_client, sample_event_data):
    ...
    events_to_create.append(
        {**sample_event_data, "user_id": user2_id, "event_type": "click"},
    )
    events_to_create.append(
        {**sample_event_data, "user_id": user2_id, "event_type": "page_view"},
    )
    events_to_create.append(
        {
            **sample_event_data,
